...
export function SucursalCard({
  ...
  return (
    <Card className="border border-gray-200 rounded-md hover:shadow-xl transition-shadow duration-300 sm:min-h-[500px] xl:min-h-[650px] 2xl:min-h-[620px] flex flex-col justify-between py-8 px-6">
