...
export default async function HomePage() {
  const valuesicea = await import('@/lib/data').then((data) => data.getValuesIcea());
  const companies = await import('@/lib/data').then((data) => data.getCompanies());
  const iceastats = await import('@/lib/data').then((data) => data.getIceaStats());
